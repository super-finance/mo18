...
define('CAMPAIGN_ID', "887b4540c61a72ee06c899ee5661ff8c");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '5bc7c1a3ba66745ad1cdf9a1cef5db59');
define('MP_PARAM_NAME', '__ok_');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '3a70c6313765509e40b2979b36387b71');
define('CHECK_MCPROXY_VALUE', 'eba2d1a95475493cdb98aa06632dfeb7b084f972a22d65a7af72162897bddf24');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '5515.3');
